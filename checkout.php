...
if(isset($_POST['order'])){
   ...
   $address = $_POST['street'] .', '. $_POST['city'] .'-'. $_POST['postal_code'] .', '. $_POST['state'] .', '. $_POST['country'] .' - '. $_POST['pin_code'];
   ...
   <h3>Your Orders</h3>
      ...
      <div class="flex">
         ...
         <div class="inputBox">
            ...
            <input type="text" name="postal_code" placeholder="e.g. 44600" class="box" maxlength="50">
         </div>
         <div class="inputBox">
            <span>Address:</span>
            <input type="text" name="street" placeholder="e.g. Lainchaur-26" class="box" maxlength="50" required>
         </div>
         <div class="inputBox">
            <span>City:</span>
         ...
         <div class="inputBox">
            <span>Pin Code :</span>
            <input type="number" min="0" name="pin_code" placeholder="e.g. 1234" min="0" max="999999" onkeypress="if(this.value.length == 6) return false;" class="box" required>
         </div>
      </div>
